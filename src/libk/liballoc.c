/*
 * This file is part of Durand Miller's PUBLIC-DOMAIN liballoc with slight
 * modifications and support for stulta.
 */
...
{
    return vmm_alloc_pages(kernel_pd, 0, pages, 0);
}

int liballoc_free(void* ptr, int pages)
{
    vmm_unmap(ptr, pages, 1);
